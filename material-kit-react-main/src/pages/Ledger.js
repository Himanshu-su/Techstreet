...
const handleDownload = async () => {
  ...
  const downloadApi = `https://dev.techstreet.in/vmsglen/public/api/ledger/export?from=${fromDate}&to=${toDate}`;
...
{datesSelected && (
  ...
  type='button'
    onClick={() => {
     ...
     handleDownload(`https://dev.techstreet.in/vmsglen/public/api/ledger?from=${fromDate}&to=${toDate}`)
    }}
    style={{
      width: '60px',
      height: '50px',
